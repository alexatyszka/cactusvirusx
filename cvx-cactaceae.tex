...
%B: NOTE: Cactaceae never italicized --> plant family names not italicized by convention
%--------------------------------------------------
\begin{document}
%--------------------------------------------------
%
...
%Plant viruses were the earliest characterized viruses, beginning with Mayer's publication on his discovery of \textit{Tobacco Mosaic Virus} in 1886 on tobacco plants \citep{mayer1886mosaikkrankheit} which followed 
...
For over a century, subsequent studies were limited to observational data \citep{}, often augmented with clever experimental approaches \citep{}. %citations are 1) microscopy and 2) inoculations.
...
It is readily accessible, inexpensive, with a massively higher throughput, and able to rapidly (albeit crudely) identify organisms from seemingly any sampled surface of the Earth.
One common thread is that virtually every macro-organism genome study uncovers a micro-organismal metagenome, composed of both targeted host sequences and those from myriad co-existing organisms. %cite the WashU thesis or paper(s) arising
%maybe one of these, if appropriate: \citep{delwart_viral_2007,lefeuvre_evolution_2019,schulz_towards_2017}
...
Metagenomic samples have yielded an enormous number of genomes and have vastly expanded the tree of life \citep{schulz_towards_2017,hug_new_2016,gregory_marine_2019,lefeuvre_evolution_2019,shi_redefining_2016}. 
%this is an unusually large in-line citation set. I would pick one or two transformative studies, not the whole gamut.
%
%B: I removed "hundreds of thousands," because that order of magnitude number is not mentioned in any of the studies! And, depending on what you think a "genome" is, even a vaguely guesstimated number is certainly much, much higher. Many orders of magnitude higher.
%Metagenomic analysis of various plant species has yielded novel insights on viral evolution, adaptation, and transmission. %(citations needed). %B: you'll have a terribly difficult time finding citations for insights into viral adaptation on plant species because there are not likely to be many. More importantly, this sentence seems to state that metagenomes contribute "insights", which is not insightful. We should discuss this more broadly in the context of writing. 


%rm: this statement is self-evident from the name: The International Committee on Taxonomy of Viruses (ICTV) presently advises the taxonomy and approval of virus nomenclature \citep{simmonds2017virus,lefkowitz2018,ictv2020}.
...
Their positive-sense, single-stranded RNA genomes consist of roughly 6,600 bp of positive-sense single-stranded RNA. %cite
Generally presenting as elongated, rod-shaped filamentous viruses, they express five primary open reading frames (ORFs): Replicase (Rep), Triple gene block (TGB), Coat protein (CP), coded in the 5' direction as well as two smaller overlapping ORFs coded in the 3' direction: ORF6 and ORF7 \citep{evallo_brief_2021,liou_complete_2004, martelli_family_2007}. %if one of these citations mentions the structure, it is sufficient.
...
The term ``plant virus'' in itself is problematic since there is strong evidence to suggest that viruses frequently spill over from fungal or invertebrate hosts \citep{lefeuvre_evolution_2019}. %this is possibly important and I have not read the paper. The interpretation of possibility of spillover is critical. Make sure that there are documented cases where a species jumps host across this chasm!
...
A single-stranded RNA virus has a faster rate of evolution than a host plant. %B: just one virus is considered in this whole section?
...
%\subsection*{Host Species and Tissues} %alternative
...
%FIXME: Describe here briefly how the previously published viral sequence data was collected
