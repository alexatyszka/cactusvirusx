...
\newpage{}
 ...
 \begin{NoHyper}
 \caption{
A maximum likelihood tree of newly discovered, newly assembled, and previously described potexviruses. The new sequences expand the known number of potexviruses within previously described genera. Although many new samples have short branch lengths when placed on a tree, host species is variable, and each clade delimited by the phylogenetic species concept (indicated by wide gradient bars covering sample name and host) is found in more than one genus.
