...
The 72\% cutoff for species groupings as defined by the ICTV for members of the \textit{Potexvirus} genus \citep{ICTV_potexviruses} has no universal calculation criteria and can be calculated in multiple ways depending on alignment or gap penalties. 
...
% I get an extension error because of the file name period: \includegraphics[width=1.0\textwidth]{figures/heatmap.rawseqdist-ed.pdf}
\label{fig:tissuetype}
\end{figure}
\clearpage
