...
Perhaps the most recent advancement in virology has been the advent of faster, cheaper, higher-throughput environmental metagenomic techniques.
...
Libraries were sequenced on a single lane of Illumina \mbox{HiSeq}~4000 or Illumina \mbox{NovaSeq}~6000 platform (paired-end 150 bp reads) at the Duke University Center for Genomic and Computational Biology.
The number of resulting read pairs (for the twenty-three samples presented here) ranged from 4,148,932 to 9,618,084 with a median of 6,363,556 and an average of 6,293,553 (Table~S1).
...
1. Phylogeny with species names included, new species bolded.
...
4. Table of pairwise distances in nucleotide and aa, possibly color-coded? 
Supplemental figures:
5. full gene phylogenies for each gene in genome
