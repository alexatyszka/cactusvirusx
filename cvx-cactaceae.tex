...
One common thread is that virtually every macro-organism genome study uncovers a micro-organismal metagenome, composed of both targeted host sequences and those from myriad co-existing organisms. %B: cite the WashU thesis or paper(s) arising?
...
Metagenomic studies have yielded an enormous number of genomes and have vastly expanded the tree of life \citep{schulz_towards_2017,hug_new_2016,gregory_marine_2019,lefeuvre_evolution_2019,shi_redefining_2016}. 
...
%B: Metagenomic analysis of various plant species has yielded novel insights on viral evolution, adaptation, and transmission. %(citations needed). %B: we'll have a terribly difficult time finding citations for insights into viral adaptation on plant species because there aren't m/any. More importantly, this sentence seems to state that metagenomes contribute "insights", which is not insightful!
%
