...
Sequence similarity methods are an alternative method that has been used to to delimit viral species.
(%fixme, cite)
...
\newpage{}
 ...
 \begin{NoHyper}
 \caption{
Maximum likelihood tree for full genome sequences from selected potexviruses. UFboot scores are represented on nodes. Tips are characteristically arranged in large groups with short branches, subtended by a longer branch. This subset of cactus-infecting potexviruses displays narrow sampling across related cohort plants whic may represent local viral transmission from plant to plant.
}
 \label{fig:fig1}
 \end{NoHyper}
 \end{figure}
