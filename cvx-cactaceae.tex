...
% FIXME: this below is how we got the sequence for the analyses, which are above. The data acquisition should be placed before the analyses. (Move up and in order.)
%
...
Percentage sequence distance was calculated for Coat Protein and RdRp nucleotides and amino acids using SDT XXX. %FIXME version missing
