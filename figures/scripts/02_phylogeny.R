...
library(ape)
library(ggplot2)
host.info.details <- read.csv("figures/scripts/phylogeny_hosts.csv", stringsAsFactors = FALSE)
...
gheatmap(p, heatmapData[c(4,6,7)], colnames=F, 
         hjust=0.3, offset=0.65, width=0.2)+
  xlim(0,1.7)
