...
#      hostinfo$host[j] <- md$host[grep(treetempphylo$tip.label[j],md$Name_updated)]
#      hostinfo$hostgenus[j] <- md$hostgenus[grep(treetempphylo$tip.label[j],md$Name_updated)]
...
treetemp@phylo <- root(treetemp@phylo, outgroup=c("D29630.1"))
...
ggtree(treetemp, ladderize=T, show.legend = FALSE, aes(color=hostgenus))  +
  #aes(color=group) +
  #%<+% hostinfo+
  scale_color_manual(name="Host plant genus",values=c("#BE81EF", "#00A9E7", "#00B9A5", "#3FB13A", "#B39B00", "#E67E67", "#EC6DC4", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#a6cee3",
"#1f78b4",
"#b2df8a",
"#33a02c"))+
  #host tip labels:
