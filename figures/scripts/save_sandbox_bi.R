...
#Sandbox for BI, saving all items needed for tree generation and experimentation
#the objects created in this file are intended to be loaded and used in phylogeny_annotation.R
#packages
library(treeio)
library(dplyr)
library(tidytree)
...
library(ggplot2)
getwd()
directory <- "examplepath/cactusvirusx/"
setwd(dir = directory)
