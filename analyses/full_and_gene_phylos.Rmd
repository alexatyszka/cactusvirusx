...
ggtree(treetemp, ladderize=T, show.legend = FALSE, aes(color=host))  +
  #aes(color=group) +
  #%<+% hostinfo+
  scale_color_manual(values=c("#BE81EF", "#00A9E7", "#00B9A5", "#3FB13A", "#B39B00", "#E67E67", "#EC6DC4", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#a6cee3",
"#1f78b4",
"#b2df8a",
"#33a02c"))+
  #theme(legend.position="bottom")+
  #host tip labels:
  geom_tiplab(aes(label=host, subset = !is.na(host)), family='mono',fontface= "bold", linetype="dotted", align=T, fontsize=3, na.rm=F, offset=1.5) +
    #name tip labels:
  geom_tiplab(aes(), geom="label",fontsize=3, fill="white", offset.text=0, fontface= "bold",family='mono', align=F, label.size = 0)+
  #scale
  geom_treescale(x=0, y=60, fontsize = 8, family = "mono") +
  ggplot2::xlim(0, 5.5)+ 
  theme(text=element_text(family="mono"), plot.margin = unit(c(8,8,8,8), "mm")) 
