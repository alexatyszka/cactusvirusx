...
reload.md()
#fetching nodes for tree and figuring out roots. outdated and not useful for subsequent file executions
...
Store tips for each variant. Use tips.store values for clades.
```{r eval=FALSE}
