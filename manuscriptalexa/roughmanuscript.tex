...
%Further, these viruses are not specific to their first reported host - in fact, there is no way to know that this first reported host is part of a systemic infection trend rather than a chance opportunistic case. In some reports, as many as six different cactus viruses can co-infect a single cactus, demonstrating the viral ability to opportunistically infect hosts and present problems for viral taxonomists. 
...
%-naming: brandes 1959 already had questions about the naming system
...
%provides insights that help bridge the gap between historic knowledge and current studies
...
%Note for KR: Could you tell me if this procedure is correct for the samples in this paper? Copypasted from your rsi paper, but I don't want to steal the exact words. 
...
%Add selection methods, further gene tree analysis
%Should I say gene or protein?

\section*{Results- not finished}
%For example, the molecular selection analysis should likely follow the figures about sequencing analyses and/or structure of the genome, and expression data. Phylogeny or phylogenies could be in the middle.

%Phylogeny - sequencing analyses/structure - molecular selection
