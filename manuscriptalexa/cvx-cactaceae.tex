...
\textit{Potexvirus} species members are positive-sense single-stranded RNA viruses known to infect many species of flowering plants, including \textit{Cactaceae}. 
...
%B: No reason to name a few of them and vaguely restate the first sentence.
The taxonomic naming schemes often employ outdated plant name synonyms, complicating taxonomic assignments.  %B: this informally reads like, "taxonomy complicates taxonomy", but it should read "taxonomy is hard with little or no data, but easier with more data"
Also, the source of infections in cultivated plants is unclear, as is the distribution of and significance of infections in wild species of cacti. %B: This will be true after your study, as well, so maybe it's best left out of the abstract of the study?
The lack of clarity is partly related to low sampling across the family. %B: one more instance of not crux of this study?
